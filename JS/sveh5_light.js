...
function initParam() {
    ...
    var e = location.href.split("#")[0]
      , t = "http://h5.lt3d.cn/h5/sign.php?url=" + encodeURIComponent(e);
    $.ajax({
        type: "get",
        async: !0,
        url: t,
        success: function(e) {
            var t = JSON.parse(e);
            wx.Timestamp = t.Timestamp,
            wx.Noncestr = t.Noncestr,
            wx.Signature = t.Signature,
            wx.Appid = t.Appid,
            wx.config({
                debug: !1,
                appId: wx.Appid,
                ...
                jsApiList: ["scanQRCode", "onSearchBeacons", "stopSearchBeancons", "startMonitoringBeacons", "stopMonitoringBeacons", "onBeaconsInRange", "startSearchBeacons", "onMenuShareTimeline", "onMenuShareAppMessage", "onMenuShareQQ"]
            })
        },
        errors: function(e) {
            console.log("get wxAPI error: " + e)
        }
    })
}
canRunES6("let a = 1;") || (alert("因您的系统或者微信版本过低，系统自动匹配进入2D导航，暂停使用路线与语音导航功能，期待您升级享用最优版本！"),
...
wx.Appid = "",
$(function() {
//  isWxBrowser() || alert("为了获得更好的体验，请用微信打开")
});
...
host.indexOf("10.0.0.11") >= 0 ? $.SVE_H5_URL = "http://10.0.0.11/3dNavSystemHospitalH5/" : host.indexOf("localhost") >= 0 ? $.SVE_H5_URL = "http://10.0.0.11/3dNavSystemHospitalH5/" : $.SVE_H5_URL = "../";
...
function renderDepartments(e) {
    ...
    for (var n in t.response) {
        ...
        l += '<img src="images/default.png" data-src="' + upLoadPath + i + '"/></center><p>',
        l += s + "</p></a></li>",
...
function renderDepDetail(e) {
    ...
    "" === s || "string" != typeof s ? $("#page-dep-detail img").attr("src", "images/hospital_img.png") : $("#page-dep-detail img").attr("src", upLoadPath + s)
}
function renderExpertList(e) {
    ...
    for (var d in t)
        ...
        i += "<img src='images/default.png' data-src='" + upLoadPath + l + "' class='header'>",
        i += "<div class='info_box'>",
        i += "<div class='name'>" + s + "</div>",
        i += "0" !== n && "0" !== o ? "<div class='professor'>" + n + "," + o + "</div>" : "0" !== n && "0" === o ? "<div class='professor'>" + n + "</div>" : "0" === n && "0" !== o ? "<div class='professor'>" + o + "</div>" : "<div class='professor'>医务人员</div>",
        i += "<div class='info'>" + c + "</div>",
        i += "</div></a><div class='clearfix'></div></li>",
        $("#page-expert-list .expert_list ul").html(i)
}
function renderExpertDetail(e) {
    ...
    i = r.workTime,
    l = r.roomId,
    "0" !== o && "0" !== n ? $("#page-expert-detail .personal-msg .expert-msg").text(o + "," + n) : "0" !== o && "0" === n ? $("#page-expert-detail .personal-msg .expert-msg").text(o) : "0" === o && "0" !== n && $("#page-expert-detail .personal-msg .expert-msg").text(n),
    $("#page-expert-detail .personal-msg .expert-msg").text().length < 5 && $("#page-expert-detail .personal-msg .expert-msg").css("padding-right", "1em"),
...
function initPeoplePic() {
    ...
    e <= 1 || 0 === e ? (scale.x = $(window).width() / 1080,
    scale.y = $(window).height() / 1920) : (scale.x = e,
    scale.y = t),
...
function renderSelfModelSlide(e) {
    ...
    for (var i in a)
        t += '<a href="#page-self-service-rusult" data-transition="slide"><li dataid="' + a[i].ID + '">' + a[i].Name + "</li></a>";
...
$(window).bind("popstate", function(e) {
    ...
    if (popped = !0,
    !a && $(".index").hasClass("ui-page-active") && wx.closeWindow(),
    !a && $("#page-self-service").hasClass("ui-page-active")) {
        var i = !0
          , s = !0;
        "none" != $("#self-illness-slide").css("display") && (i = !1,
        window.history.pushState({
            title: "自助导诊"
        }, "自助导诊", "/h5/index.html#page-self-service"),
        $("#self-illness-slide").css("display", "none")),
        "0px" == $("#self-model-slide").css("left") && "none" == $("#self-illness-slide").css("display") && i && ('{"title":"自助导诊"}' != JSON.stringify(window.history.state) && window.history.pushState({
            title: "自助导诊"
        }, "自助导诊", "/h5/index.html#page-self-service"),
        $(".mash").trigger("touchstart")),
        "none" != $("#self-sickness-slide").css("display") && (s = !1,
        window.history.pushState({
            title: "自助导诊"
        }, "自助导诊", "/h5/index.html#page-self-service"),
        $("#self-sickness-slide").css("display", "none"),
        $(".self-part-sub").removeClass("self-part-sub-current")),
        "0px" == $("#self-part-slide").css("left") && "none" == $("#self-sickness-slide").css("display") && s && ('{"title":"自助导诊"}' != JSON.stringify(window.history.state) && window.history.pushState({
            title: "自助导诊"
        }, "自助导诊", "/h5/index.html#page-self-service"),
        $(".mash").trigger("touchstart"))
    }
    reSetNavIcon(pageSymble = location.href.indexOf("#") > -1 ? location.href.split("#")[1] : "index")
}),
$(".bottom_menu ul li a").click(function() {
    ...
    "index" != $(this).attr("pageid") ? window.history.replaceState({
        title: "导航"
    }, "导航", "/h5/index.html") : index_status ? window.history.replaceState({
        title: "导航"
    }, "导航", "/h5/index.html") : index_status || (index_status = !0)
}),
$(document).on("pageinit", "#page-hospital", function(e) {
    reSetNavIcon(pageSymble = "hospital");
    var t = (new Date).valueOf();
    "null" != JSON.stringify(mGetItem("page-hospital")) && parseInt(mGetItem("page-hospital-time")) > t - http_cache_time ? (renderHospital(mGetItem("page-hospital")),
    console.info("读取医院信息缓存")) : ($.ajax({
        type: "get",
        ...
        success: function(e) {
            ...
            mSetItem("page-hospital-time", (new Date).valueOf())) : console.info("请求数据出错.")
        },
        errors: function(e) {
...
$(document).on("pageinit", "#page-departments", function(e) {
    ...
    var t = (new Date).valueOf();
    "null" != JSON.stringify(mGetItem("page-departments")) && parseInt(mGetItem("page-departments-time")) > t - http_cache_time ? (renderDepartments(mGetItem("page-departments")),
    console.info("读取科室列表缓存")) : $.ajax({
        type: "get",
        url: $.SVE_H5_URL + "api/info/getKeShilistH5.php",
        async: !0,
        success: function(e) {
            e ? (renderDepartments(e),
            mSetItem("page-departments", e),
            mSetItem("page-departments-time", (new Date).valueOf()),
            console.info("请求科室列表数据")) : console.info("请求数据出错.")
        },
        errors: function(e) {
...
$(document).on("pageshow", "#page-index", function(e) {
    ...
    null !== Engine.g_pInstance && Engine.g_pInstance.Start(),
    console.info("enter page page-index")
}),
$(document).on("pageinit", "#page-expert", function(e) {
    reSetNavIcon(pageSymble = "expert");
    var t = (new Date).valueOf();
    "null" != JSON.stringify(mGetItem("page-expert")) && parseInt(mGetItem("page-expert-time")) > t - http_cache_time ? (renderExpert(mGetItem("page-expert")),
    console.info("读取专家[科室]列表缓存")) : ($.ajax({
        type: "get",
        url: $.SVE_H5_URL + "api/info/getKeShilistH5.php",
        async: !0,
        success: function(e) {
            ...
            mSetItem("page-expert-time", (new Date).valueOf())) : console.info("请求数据出错.")
        },
        errors: function(e) {
...
$(document).on("pagehide", "#page-index", function(e) {
    closeLeftSide(),
    null !== Engine.g_pInstance && Engine.g_pInstance.Stop(),
...
$(document).on("touchstart", ".self-head-tag", function() {
    ...
    "null" != JSON.stringify(mGetItem("body-info")) && parseInt(mGetItem("body-info-time")) > e - http_cache_time ? (renderSelfPartSlide(mGetItem("body-info")),
    console.info("读取人体部位列表缓存")) : ($.ajax({
        type: "get",
        url: $.SVE_H5_URL + "api/info/getBodyInfoList.php",
        async: !0,
        success: function(e) {
            e ? (renderSelfPartSlide(e),
            mSetItem("body-info", e),
            mSetItem("body-info-time", (new Date).valueOf())) : console.info("请求数据出错.")
        },
        errors: function(e) {
    ...
    !$(this).hasClass("self-part-sub")) {
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                for (var o in s)
                    a += '<li class="self-part-sub" dataid="' + s[o].ID + '">' + s[o].Name + "</li>";
                t.after(a),
                i && $("#self-part-slide").animate({
...
$(document).on("click", ".self-part-sub", function() {
    ...
    $.ajax({
        ...
        async: !0,
        success: function(e) {
            e ? ($("#self-sickness-slide").show(),
            renderSicknessSlide(e)) : console.info("请求数据出错.")
        },
        errors: function(e) {
...
$(document).on("click", "#self-model-slide ul li", function() {
    ...
    $.ajax({
        type: "get",
        url: $.SVE_H5_URL + "api/info/getSuggestKeshiList.php?Id=" + e,
        async: !0,
        success: function(e) {
            if (e) {
                closeModelSide();
                var t = '<li class="list-head">自助导诊结果</li>'
                  , a = JSON.parse(e).response.RoomList;
                if (a)
                    for (var i in a)
                        t += '<li><span class="self-advice"><span>建议科室：</span><span class="room-name">' + a[i].Room_Name + '</span></span><div class="self-go"><span dataid="' + a[i].Room_ID + '" class="self-go-ahead">直达科室</span></div></li>';
                else
                    t += '<div class="self-result-content">暂无数据</div>';
                $("#page-self-service-rusult ul").html(t)
            } else
                console.log("请求数据出错.")
        },
        errors: function(e) {
...
$(document).on("touchstart", "#page-self-service map area", function() {
    ...
    $("#self-model-slide").scrollTop(0);
    var e, t = $(".self-adult-tag li:first-child").hasClass("self-tag-current"), a = $(".self-sex-tag li:first-child").hasClass("self-tag-current"), i = $(this).attr("dataid") || "all";
...
$(document).on("touchstart", ".reversal", function() {
    ...
    $("#page-self-service .container").html(i),
    initPeoplePic()
}),
...
$(function() {
    ...
    function o(e) {
        var t = new Request("project.zip");
        fetch(t).then(function(e) {
            return 200 === e.status || 0 === e.status ? Promise.resolve(e.blob()) : Promise.reject(new Error(e.statusText))
        }).then(JSZip.loadAsync).then(function(t) {
            e(t)
        })
    }
    function n() {
    ...
    function l(e) {
        var t, a, i = "";
        for (var s in e)
            null == mGetItem("v" + e[s]) && (null == e[s] && (e[s] = "位置点"),
            i += e[s] + ",");
    ...
    function r(e) {
        var t = 0;
        e.length > 0 && (audio.currentTime = 0,
        audio.pause(),
        ...
        audio.onended = function() {
            t < e.length ? (audio.currentTime = 0,
            audio.pause(),
            audio.src = mGetItem("v" + e[t]),
            ++t,
            setTimeout(function() {
                audio.play()
            }, 0)) : Engine.g_pInstance.m_pProject.VoiceEnd()
        }
    }
    function c(e) {
        console.info("播放动画：" + e),
        function(e, t) {
            ...
            a.style.cssText = "position:absolute;padding:5px; top:0px; left:0px; right:0px;margin:auto; z-index:999999;background-image:linear-gradient(45deg, #eee 25%, transparent 25%, transparent 75%, #eee 75%, #eee 100%),linear-gradient(45deg, #eee 25%, white 25%, white 75%, #eee 75%, #eee 100%);",
            document.body.appendChild(a),
            setTimeout(function() {
                a.style.webkitTransition = "-webkit-transform 0.5s ease-in, opacity 0.5s ease-in",
                a.style.opacity = "0",
                setTimeout(function() {
    ...
    setTimeout(function() {
        initStatus || (alert("因您当前的网络环境不稳定，系统自动匹配进入2D导航，暂停使用路线与语音导航功能，期待您在网络环境稳定下享用最优版本！"),
        location.href = $.SVE_H5_URL + "c/index.html")
    }, 35e3),
    e = function() {
        wx.ready(function() {
            var e;
        ...
        e && ($(".start_input input").attr("roomid", e.id),
        $(".start_input input").val(e.name))
    }
    ,
    function(e) {
        var t = (new Date).valueOf();
        if ("null" != JSON.stringify(mGetItem("room-list")) && parseInt(mGetItem("room-list-time")) > t - http_cache_time) {
            var a = JSON.parse(mGetItem("room-list")).response;
            e(a),
            console.info("读取房间列表缓存")
        } else
            $.ajax({
                type: "get",
                ...
                async: !0,
                success: function(t) {
                    t ? (e(JSON.parse(t).response),
                    mSetItem("room-list", t),
                    mSetItem("room-list-time", (new Date).valueOf())) : console.info("请求数据出错.")
                },
                errors: function(e) {
        ...
        var options = {
            ...
            pSetNavPoint: C,
            pChickTouchMove: N,
            pPostBlueToothList: M,
            pVoicePost: l,
            pMovie: c,
            pShowActiveLayer: h,
            pCallback: function(t) {
                null == t && (Engine.g_pInstance.Start(),
                e(),
                initStatus = !0)
            },
            pFloorData: null
    ...
    function p(e) {
        d = f,
        $(".floor_box ul").scrollTop(d * (e - 1))
    }
    function u(e, t) {
        for (var a, i, s, o = "", n = 0; n < e; ++n)
            o += "<li house-id='" + t + "'>" + (n + 1) + "F</li>";
        $(".floor_box ul").html(o),
        a = 0,
        i = 0,
        s = 0,
        $(".floor_box ul li").unbind("click").bind("click", function(e, t) {
            var o = $(".floor_box ul li").index($(this))
            ...
            $(".floor_box ul").children("li").each(function(e) {
                Math.abs($(this).position().top) < 2 * f / 3 && ($(this).addClass("top"),
                i = (a = e) + 3,
                ...
                s == a ? $(".floor_box ul li").eq(s).removeClass("top cmiddle cbottom").addClass("ctop").siblings().removeClass("ctop") : s == i ? $(".floor_box ul li").eq(s).removeClass("bottom ctop cmiddle").addClass("cbottom").siblings().removeClass("cbottom") : s < i && s > a && $(".floor_box ul li").eq(s).removeClass("middle ctop cbottom").addClass("cmiddle").siblings().removeClass("cmiddle"))
            }),
            void 0 == t) {
                var l = !1;
                $(".history-rollback-wrapper ul li").each(function(e) {
                    if ($(this).attr("layer-id") == o && $(this).attr("house-id") == n) {
                        $(".history-rollback-wrapper ul li").eq(e).trigger("touchstart");
    ...
    function h(e) {
        ...
        $(".floor_box ul li").eq(current_floor.LayerId).trigger("click", {
            type: "noNeedActive"
        }),
        $(".history-rollback-wrapper ul li").each(function() {
            current_floor.LayerId == $(this).attr("layer-id") && current_floor.HousId == $(this).attr("house-id") && $(this).trigger("touchstart", {
                type: "noNeedActive"
            })
        })
    }
    function m(e) {
        var t = "";
        for (var a in e)
            t += "<li layer-id='" + e[a].LayerId + "' house-id='" + e[a].HousId + "' p-id='" + e[a].PId + "'><span class='floor-item'> " + (e[a].LayerId + 1) + "F</span>",
            a < e.length - 1 && (t += "<span class='icon-chevron-thin-right arrow-round'></span>"),
            t += "</li>";
    ...
    function b() {
        ...
        var e = (new Date).valueOf();
        "null" != JSON.stringify(mGetItem("base-position-list")) && parseInt(mGetItem("base-position-list-time")) > e - http_cache_time ? (y(mGetItem("base-position-list")),
        console.info("读取基础设施信息缓存")) : $.ajax({
            type: "get",
            async: !0,
            ...
            success: function(e) {
                ...
                mSetItem("base-position-list-time", (new Date).valueOf())) : console.info("请求数据出错.")
            },
            errors: function(e) {
    ...
    function y(e) {
        ...
        for (var i in t)
            t[i].iconUrl && (a += '<div sort-id="' + t[i].ID + '" class="base-item"><img src="../' + t[i].iconUrl + '" alt="基础设施"/><span class="base-text">' + t[i].HyName + "</span></div>");
        a += "</div>",
        $(".search-list").html(a);
        var s = (new Date).valueOf();
        "null" != JSON.stringify(mGetItem("page-departments")) && parseInt(mGetItem("page-departments-time")) > s - http_cache_time ? (_(e = mGetItem("page-departments")),
        console.info("读取科室列表缓存")) : $.ajax({
            type: "get",
            url: $.SVE_H5_URL + "api/info/getKeShilistH5.php",
            async: !0,
    ...
    function _(e) {
        for (var t = JSON.parse(e), a = null, i = null, s = '<div class="panel-box">', o = 0; o < t.response.length; o++)
            if (i = (a = t.response[o]).roomChildList) {
                s += '<div class="pannel"><div class="panel-head"><span class="title">' + a.roomName + '</span><span class="fold-icon"><span class="icon-chevron-thin-down"></span></span></div><div class="panel-body" style="display: none">';
    ...
    function x(e, t) {
        ...
        for (var o in a)
            i = a[o],
            ("" === t || i.roomName.indexOf(t) >= 0) && i.roomName.indexOf("楼梯") < 0 && "" != i.roomID && i.roomName.indexOf("电梯") < 0 && i.roomName.indexOf("卫生间") < 0 && (s += "<li roomid='" + i.roomID + "'>",
            s += "<span class='ico_addr'></span><span class='context'>" + i.roomName + "</span>",
            "string" == typeof i.FloorID && "" != i.FloorID && (s += "<span class='floor-num'>" + i.Building_ID + "-" + i.FloorID + "</span>"),
            s += "</li>");
        "" === s && (s = "<li style='text-align: center;color: #999;'>无匹配信息.</li>"),
        $(".search-list").html(s)
    }
    function w(e) {
        e ? ($(".mash").hide(),
        ...
        $(".floor_box").hide(),
        console.info("由楼宇进入院区")) : ($(".floor_box").show(),
    ...
    function k(e) {
        !function(e, t) {
            ...
            a.onclick = function() {
                ...
                mSetItem(defaultStart, JSON.stringify(e)),
                D("设置成功!", 500)
            }
            ,
            a.innerHTML = e,
            a.style.cssText = "font-size:16px; max-width:100%; background:#000; opacity:0.98; height:40px; color:#fff; line-height:40px; text-align:center; border-radius:5px; position:absolute; left:0px; right:0px; bottom:13.5rem;margin:auto; z-index:999999;",
            document.body.appendChild(a),
            setTimeout(function() {
                a.style.webkitTransition = "-webkit-transform 0.5s ease-in, opacity 0.5s ease-in",
                a.style.opacity = "0",
    ...
    function C(e, t, a) {
        if ("" !== t) {
            ...
            $(".btn-exit-rollback").trigger("touchstart")
        }
    }
    function N() {
    ...
    function D(e, t) {
        ...
        var a = document.createElement("div");
        a.innerHTML = e,
        a.style.cssText = "width:60%; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; min-width:150px; background:#000; opacity:0.5; height:40px; color:#fff; line-height:40px; text-align:center; border-radius:5px; position:absolute; top:0px; left:0px; right:0px; bottom:0px;margin:auto; z-index:999999; font-weight:bold;",
        document.body.appendChild(a),
        setTimeout(function() {
            a.style.webkitTransition = "-webkit-transform 0.5s ease-in, opacity 0.5s ease-in",
            a.style.opacity = "0",
    ...
    $(".floor_box ul").scroll(function() {
        ...
        $(this).children("li").each(function(s) {
            Math.abs($(this).position().top) < 2 * f / 3 && ($(this).addClass("top").siblings().removeClass("top"),
            a = (t = s) + 3,
            ...
            i == t ? e.eq(i).removeClass("top cmiddle cbottom").addClass("ctop").siblings().removeClass("ctop") : i == a ? e.eq(i).removeClass("bottom ctop cmiddle").addClass("cbottom").siblings().removeClass("cbottom") : i < a && i > t && e.eq(i).removeClass("middle ctop cbottom").addClass("cmiddle").siblings().removeClass("cmiddle"))
        })
    }),
    ...
    $(document).on("touchstart", ".basePosition .base-item", function() {
            ...
            success: function(e) {
                e ? function(e) {
                    ...
                    for (var i in a)
                        ...
                        "string" == typeof a[i].Floor_ID && "" != a[i].Floor_ID && (t += "<span class='floor-num'>" + a[i].Floor_ID + "</span>"),
                        t += "</li>";
    ...
    $(document).on("click", ".base-position-list li", function() {
        var e = $(this).attr("room-id")
          , t = $(this).children(".context").html();
        isStartInput ? ($(".start_input input").attr("roomid", e),
        $(".start_input input").val(t),
        k(t)) : ($(".end_input input").attr("roomid", e),
        $(".end_input input").val(t)),
    ...
    $(document).on("click", ".panel-head", function() {
        ...
        a.hasClass("icon-chevron-thin-down") ? a.removeClass("icon-chevron-thin-down").addClass("icon-chevron-thin-up") : a.removeClass("icon-chevron-thin-up").addClass("icon-chevron-thin-down"),
        e.is(":visible") ? (e.hide("fast"),
        t.css("border-bottom", "none")) : (e.show("slow"),
        t.css("border-bottom", "1px solid #DDDDDD"))
    }),
    $(".input-head .visual-input input").bind("input focus propertychange", function(e) {
        ...
        var t = $(this).val();
        "" !== t && ($(".input-head .visual-input .ico-qrcode").css("display", "none"),
        $(".input-head .visual-input .ico-close").css("display", "inline-block")),
        "focus" != e.type && "input" != e.type || function(e) {
            var t = (new Date).valueOf();
            if ("null" != JSON.stringify(mGetItem("keshi-list")) && parseInt(mGetItem("keshi-list-time")) > t - http_cache_time) {
                ...
                $.ajax({
                    ...
                    success: function(t) {
                        ...
                        mSetItem("keshi-list-time", (new Date).valueOf())) : console.info("请求数据出错.")
                    },
                    errors: function() {
    ...
    $(document).on("click", ".search-list .delete", function(e) {
        var t = $(this).parent().attr("roomid");
    ...
    $(".input-head .visual-input .ico-close").live("touchstart", function() {
    ...
    $(".search-list li").live("click", function() {
        if ($(this).hasClass("input-history-clear") || $(this).hasClass("input-history-li") || $(this).hasClass("input-history-none")) {
            if ($(this).hasClass("input-history-clear") && window.confirm("清除历史记录?")) {
            ...
            "请输入起点" === $("#pop-input-start input").attr("placeholder") ? (k($(this).children(".context").text()),
            $(".start_input input").attr("roomid", $(this).attr("roomid")),
            $(".start_input input").val($(this).children(".context").text())) : ($(".end_input input").attr("roomid", $(this).attr("roomid")),
            $(".end_input input").val($(this).children(".context").text())),
            $.mobile.changePage("", {
                transition: "slide"
            }),
            $("#pop-input-start input").val("")
    }),
    $(".search-list").live("touchstart", function() {
        document.activeElement.blur()
    }),
    $(".navigation_btn").live("touchstart", function() {
        if ($(".search_direction_box").is(":hidden"))
            ...
            audio.volume = 1;
            var e = $(".start_input input").attr("roomid")
              , t = ($(".start_input input").val(),
            $(".end_input input").attr("roomid"));
            $(".end_input input").val();
            e && t ? e != t ? (isNowNavigating = !0,
            Engine.g_pInstance.m_pProject.Navigate(e, t, 0),
            $(".search_direction_box").hide(),
            isNavSuccess ? $(".navigation_btn").hide() : ($(".navigation_btn").show(),
            isNavSuccess = !0,
            D("无法找到当前线路.", 1500))) : D("起点和终点相同！", 1500) : alert("起点或终点异常.")
        }
    }),
    $(".btn-exit-rollback").live("touchstart", function() {
        audio.volume = 0,
        Engine.g_pInstance.m_pProject.CloseNavBack(),
        $(".history-rollback-wrapper").css("display", "none"),
        $(".navigation_btn").show(),
        $(".navigation_btn").text("导航")
    }),
    $(".current-address").live("click", function() {
        var e = "<li>请选择要进入的场景</li>";
        for (var t in MiaokitDC.DC.m_aWork)
            0 == MiaokitDC.DC.m_aWork[t].m_nIndex && (e += "<li class='exterior'>" + MiaokitDC.DC.m_aWork[t].m_pID + "</li>");
        for (var t in MiaokitDC.DC.m_aWork)
            0 != MiaokitDC.DC.m_aWork[t].m_nIndex && (e += "<li class='work' data-id='" + MiaokitDC.DC.m_aWork[t].m_pID + "'>" + MiaokitDC.DC.m_aWork[t].m_pID + "</li>");
    ...
    $("#left-slide li").live("click", function() {
        ...
        $(this).hasClass("exterior") && Engine.g_pInstance.m_pProject.GoOutWork()
    }),
    ...
    $(".two_d_btn").live("touchstart", function() {
        "3D" === $(this).text() ? Engine.g_pInstance.m_pProject.SwitchViewMode(ViewMode.View3D) : Engine.g_pInstance.m_pProject.SwitchViewMode(ViewMode.View2D)
    }),
    $(".reset").live("touchstart", function() {
        Engine.g_pInstance.m_pProject.Reset()
    }),
    $(".two_code_btn").live("touchstart", function() {
        wx.scanQRCode({
            needResult: 1,
    ...
    $(".input-head .visual-input .ico-qrcode").live("touchstart", function() {
        wx.scanQRCode({
            needResult: 1,
            desc: "scanQRCode desc",
            success: function(e) {
    ...
    $("canvas").live("touchstart", function() {
        $(".search_direction_box").hide(),
        $(".navigation_btn").text("导航")
    }),
    $("#page-expert-detail .department-msg .go-ahead").live("touchstart", function() {
        var e = $(this).attr("room-id");
        $(".end_input input").attr("roomid", e),
        $(".start_input input").attr("roomid") ? ($.mobile.changePage("", {
            transition: "slide"
        }),
        reSetNavIcon("index"),
        $(".history-rollback-wrapper").css("display", "none"),
        ...
        $(".search_direction_box").show(),
        $(".btn-exit-rollback").trigger("touchstart"),
        $(".navigation_btn").trigger("touchstart")) : alert("请先到导航页输入起点位置.")
    }),
    $(document).on("touchstart", "#page-self-service-rusult .self-go-ahead", function() {
        var e = $(this).attr("dataid")
    ...
    $(".choose-set-point li .set").click(function() {
        ...
        case "start":
            ...
            break;
        case "end":
            $(".start_input input").attr("roomid") != t.id ? ($(".end_input input").attr("roomid", t.id),
            $(".end_input input").val(t.name),
            $(".navigation_btn").trigger("touchstart"),
            $(".navigation_btn").trigger("touchstart")) : D("起点和终点相同！", 1500);
            break;
        default:
            $(".search_direction_box").hide()
        }
    ...
    $("#page-index,.bottom_menu ul li a").live("click", function() {
        $(".choose-set-point").hide()
    })
});
