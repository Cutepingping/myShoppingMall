...
if(!canRunES6("let a = 1;")){
	alert("当前手机系统不支持，请升级到Android6.0或IOS9以上版本");
	NativeObj.closeActivity();
//	window.opener=null;
//	window.open('','_self');
//	window.close();
	wx.Timestamp = "";
...
$(function() {
    ...
    setTimeout(function() {
    	if(!initStatus){
    		if(confirm("因您当前的网络环境不稳定! 点击'确认'按钮退出导航! 点击'取消'按钮持续等待!")){
...
//			window.close();
    ...
    function(e) {
        ...
        if ("null" != JSON.stringify(mGetItem("room-list")) && parseInt(mGetItem("room-list-time")) > t - http_cache_time) {
            ...
            console.log(mSetItem("room-list"));
...
//          }),
    	...
    	var floorData = mGetItem('room-list');
    ...
    $(".two_d_btn").live("touchstart", function() {
        "2D" === $(this).text() ? Engine.g_pInstance.m_pProject.SwitchViewMode(ViewMode.View2D) : Engine.g_pInstance.m_pProject.SwitchViewMode(ViewMode.View3D)
    }),
